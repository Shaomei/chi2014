...
Here we load 160K VI users (detected by VoiceOver or ChromeVox) who logged in to Facebook between 2013-05-15 to 2013-06-15. Compare them with 1M random sampled FB users, and 200K random sampled FB iOS users, both active at the same period.
